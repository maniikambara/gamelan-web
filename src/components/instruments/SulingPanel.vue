...
export default {
  ...
  setup(props, { emit }) {
    ...
    const playNote = (i) => {
      ...
      activeNote.value = i
      // Pertahankan indikator visual selama durasi nada benar-benar terdengar
      // (~5s, selaras dengan fallback duration_s di audio.js), bukan sekadar
      // durasi flash tombol yang singkat.
      setTimeout(() => {
